...
def list_cmd():
    ...
    if not accounts:
        ...
        print("Add an account with: uv run euno plugin gcal accounts add <name>")
        print("Or add a service account: uv run euno plugin gcal accounts add-service <name> --key-file <path>")
        return
