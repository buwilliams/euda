...
def _get_quote_module():
    ...
    from src.core.system.quote import euno_quote
    return {
...
def generate_cmd(
    ...
    if topic_id:
        ...
        from src.core.system.quote import _generate_quote, _get_quote_history
        from src.core.data.identity import get_identity
