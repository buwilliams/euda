"""Nextcloud integration plugin - Files, calendar, and deck operations."""
...
from plugins.nextcloud.commands import files, calendar, deck
...
def main():
    """Entry point for the Nextcloud plugin CLI."""
    app()
