"""Google Calendar integration skill - Multiple account support for Google Calendar."""
...
from skills.gcal.commands import accounts, calendars, events
...
def main():
    """Entry point for the Google Calendar skill CLI."""
    app()
