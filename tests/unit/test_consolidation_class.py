...
class TestConsolidationAppend:
    ...
    def test_append_delegates_to_append_phase(self, tmp_path):
        ...
        with patch("src.core.system.consolidation.append.append_phase") as mock_phase:
    ...
    def test_append_emits_events(self, tmp_path):
        ...
        with patch("src.core.system.consolidation.append.append_phase", return_value=1):
    ...
    def test_append_handles_errors_gracefully(self, tmp_path):
        ...
        with patch("src.core.system.consolidation.append.append_phase",
...
class TestConsolidationConsolidate:
    ...
    def test_consolidate_delegates_to_consolidate_phase(self):
        ...
        with patch("src.core.system.consolidation.consolidate.consolidate_phase") as mock_phase:
    ...
    def test_consolidate_emits_events(self):
        ...
        with patch("src.core.system.consolidation.consolidate.consolidate_phase",
...
class TestConsolidationBatchAppend:
    ...
    def test_append_batch_delegates_to_batch_phase(self):
        ...
        with patch("src.core.system.consolidation.append.append_batch_phase") as mock_phase:
    ...
    def test_append_batch_emits_events(self):
        ...
        with patch("src.core.system.consolidation.append.append_batch_phase", return_value=1):
    ...
    def test_append_batch_includes_exchange_count_in_events(self):
        ...
        with patch("src.core.system.consolidation.append.append_batch_phase", return_value=2):
    ...
    def test_append_batch_handles_errors(self):
        ...
        with patch("src.core.system.consolidation.append.append_batch_phase",
