...
class TestMemoryExpirationInvariants:
    ...
    def test_memory_valid_at_90_days(self, patch_data_dir):
        ...
        datetime.
        """
        from plugins.core.data.memory import _is_valid, VALIDITY_DAYS
    ...
    def test_expired_entries_filtered(self, patch_data_dir):
        ...
        """
        from plugins.core.data.memory import add_memory, list_memory, _save_entries, _load_entries
        ...
        with patch('plugins.core.data.memory.write_long_term_memory'):
    ...
    def test_expired_entries_archived(self, patch_data_dir):
        ...
        """
        from plugins.core.data.memory import list_memory, _save_entries
        ...
        with patch('plugins.core.data.memory.write_long_term_memory') as mock_write:
...
class TestMemoryTypes:
    ...
    def test_valid_memory_types(self):
        ...
        """
        from plugins.core.data.memory import VALID_TYPES
