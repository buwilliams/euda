...
def perform_fresh_start(create_backup_first: bool = True) -> dict:
    ...
    # Create system topics (Agents, Tasks, Projects, and Assets containers)
    from ..data.topics import get_agents_container, get_tasks_container, get_projects_container, get_assets_container
