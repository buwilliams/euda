...
from plugins.core.data.topics import (
...
from plugins.core.data.assets import list_assets, read_asset, write_asset, delete_asset
...
def api_get_topic_trace(topic_id: str, days: int = 7):
    ...
    from plugins.core.data.topics import get_topic_logs
