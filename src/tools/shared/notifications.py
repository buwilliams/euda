...
NOTE: This module is being migrated to use the "From Euno" project
for notifications. New code should use create_euno_task() instead
of queue_notification().
"""
...
def create_euno_task(
    ...
    This replaces queue_notification() - notifications now appear as tasks
    in the unified task panel.
