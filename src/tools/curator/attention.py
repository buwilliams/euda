"""
Attention tools for the Curator Agent.
...
# Base paths - Curator agent uses shared signals and its own queue
DATA_DIR = Path(__file__).parent.parent.parent.parent / "data"
SHARED_DIR = DATA_DIR / "shared"
SIGNALS_DIR = SHARED_DIR / "state" / "signals"
CURATOR_DIR = DATA_DIR / "curator"
QUEUES_DIR = CURATOR_DIR / "state" / "queue"
...
"""
    ...
    from ..profiler.profile import get_synthesis_summary
