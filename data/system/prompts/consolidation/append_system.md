...
- behavior: User preferences about how the assistant should act (e.g., "prefers concise responses", "wants topics created immediately for reminders", "dislikes being asked too many clarifying questions")
