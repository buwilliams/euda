"""
Archivist Status Tools - Progress and state reporting

Provides comprehensive status information about the archivist process
for the Adaptor Agent and other consumers. Includes:
...
# Data paths (4 levels up from src/tools/archivist/status.py)
DATA_DIR = Path(__file__).parent.parent.parent.parent / "data"
ARCHIVIST_DIR = DATA_DIR / "archivist"
STATE_FILE = ARCHIVIST_DIR / "state" / "state.json"
LOGS_DIR = ARCHIVIST_DIR / "logs"


def _load_state() -> dict:
    """Load archivist state from file."""
...
def get_archivist_status() -> str:
    """
    Get comprehensive archivist status.
...
def get_archivist_progress() -> str:
    """
...
ARCHIVIST_STATUS_TOOLS = [
    {
        "name": "get_archivist_status",
        "description": "Get comprehensive archivist status including queue, budget, current file being processed, and session statistics. Use this to understand what the archivist is currently doing.",
        "input_schema": {
            "type": "object",
            "properties": {}
        }
    ...
    {
        "name": "get_archivist_progress",
        "description": "Get session and lifetime progress statistics for archivist. Shows how many files have been processed overall.",
        "input_schema": {
            "type": "object",
            "properties": {}
        }
...
ARCHIVIST_STATUS_HANDLERS = {
    "get_archivist_status": lambda: get_archivist_status(),
    "get_archivist_progress": lambda: get_archivist_progress(),
...
if __name__ == "__main__":
    print(get_archivist_status())
    print("\n" + "="*50 + "\n")
    print(get_archivist_progress())
    print("\n" + "="*50 + "\n")
