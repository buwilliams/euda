...
See Appendix B for insight into the problems and solutions for AI-based education.
...
Appendices
A collection of resources to aid your continued exploration.
...
By default, large language models offer unstructured learning: you ask a question, get an answer, and move on.
Used alone, this approach risks shallow understanding — leading to traps like focalism, Maslow’s hammer, or centrality bias. Unstructured learning can produce confidence without comprehension — the illusion of understanding.
...
Sample of AI education programs:

Alpha School — private K-12 network where students do core academics in ~2 hours via AI/adaptive software; adults are “guides,” not teachers.

Unbound Academy — newly approved model explicitly prioritizing AI to deliver core academics.

Khan World School @ ASU Prep — online high school integrating Khanmigo AI tutoring deeply across coursework

2-Hour Learning — the AI-tutor framework (from Alpha’s cofounder), marketed as “crush academics in 2 hours,” used in Alpha and Unbound models.

Super Teacher — low-cost AI tutor positioned as “unlimited private tutoring” for elementary schools; designed to deliver core instruction.

Khanmigo (Khan Academy) — AI tutor & teacher assistant deployed across districts; increasingly used as the primary interaction layer for students in some pilots.

Kira Learning — “AI co-teacher”/tutor agents for one-on-one guidance; rolling out district-wide (e.g., Tennessee) to offload instruction/assessment tasks.

Kyron Learning — creates AI-driven interactive lessons and “conversational” video tutors that adapt in real time; pitched to deliver instruction directly.

Knewton Alta (Wiley) — longstanding adaptive courseware (AI-personalized pacing/content). Often used as the central instructional spine in higher-ed and some K-12 courses.

Alice.Tech — “Duolingo for exams”; AI generates personalized explainers/quizzes and adaptive study plans that can function as a primary study instructor.

MagicSchool — widely adopted AI platform; primarily teacher-facing today, but also ships student tools and AI tutors used as a core learning interface in some settings.
---
