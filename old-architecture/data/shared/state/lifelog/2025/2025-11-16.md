...
From this lens, the common-sense advice is understandable:
if abundance creates misalignment, then artificially adding scarcity back into your environment (don’t buy the chips) seems like the rational fix. It’s also true that exercising willpower has helped many.
...
How Thought Experiments Help Us Make a Better Sense of Health
...
It gives a more universal explanation for why health struggles persist,
and why technology—not discipline—has always been the force that frees us.
...
A civilization’s ability to reason well is proportional to its ability to inhabit hypothetical worlds. If we refuse to imagine alternatives, we stay trapped in the present. If we learn to inhabit alternatives, we discover better explanations—and better futures.
